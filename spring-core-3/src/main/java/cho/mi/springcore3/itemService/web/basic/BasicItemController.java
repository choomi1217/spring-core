package cho.mi.springcore3.itemService.web.basic;

import cho.mi.springcore3.itemService.domain.item.Item;
import cho.mi.springcore3.itemService.domain.item.ItemRepository;
...
public class BasicItemController {
    ...
    public String edit(@RequestParam Long itemId, @ModelAttribute Item item) {
